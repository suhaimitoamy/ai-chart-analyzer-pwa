import React,{useEffect,useMemo,useRef,useState}from"react";import{Activity,BarChart3,Clock3,Cpu,History,KeyRound,Radio,Settings,Terminal,Zap}from"lucide-react";
const TF={M1:60,M5:300,M15:900,M30:1800,H1:3600,H4:14400,D1:86400,W1:604800};
const p2=v=>v?Number(v).toFixed(2):"-";const money=v=>v?`$${Number(v).toFixed(2)}`:"Waiting...";
...
function atr(cs){let a=cs.slice(-14);return a.reduce((s,c)=>s+c.high-c.low,0)/(a.length||1)||.5}
